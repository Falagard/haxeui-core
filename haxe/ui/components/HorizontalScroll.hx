...
private class HorizontalScrollLayout extends DefaultLayout {
    public override function resizeChildren() {
        ...
        if (thumb != null) {
            if (scroll.min == scroll.max) {
                ...
                var minWidth:Float = innerHeight;
                if (thumb.style != null && thumb.style.minWidth != null) {
                    minWidth = Math.max(minWidth, thumb.style.minWidth);
                }
    ...
    public override function repositionChildren() {
        ...
        // This is crucial because DefaultLayout centers the thumb vertically, calculating non-integer
